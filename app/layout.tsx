...
export const metadata: Metadata = {
  ...
  description:
    'Meetora is a modern video interview platform that helps teams streamline hiring with real-time calls, scheduling, and candidate evaluation — all in one place.',
  keywords: [
    'Meetora',
  ...
  openGraph: {
    title: 'Meetora – Smart Video Interview Platform',
    description:
      'Host and manage video interviews with ease. Meetora offers high-quality calls, scheduling, and built-in evaluation tools for fast, effective hiring.',
  ...
  twitter: {
    ...
    title: 'Meetora – Smart Video Interview Platform',
    description:
      'Streamline your interviews with real-time video calls, candidate evaluation, and scheduling tools — all with Meetora.',
